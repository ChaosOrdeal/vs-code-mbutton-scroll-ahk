#IfWinActive ahk_exe Code.exe ; script is only active in VS Code
  ...
  ;   }
	MButton:: ; on middle mouse button click, do the following
		...
		noScrollZone := 5 ; no scrolling until the mouse moves at least this far
		smooth := 80 ; higher smooth value makes scroll less smooth
		acceleration := 2 ; higher acceleration value makes scroll start accelerating sooner
		slow := 110 ; lower slow value increases scroll speed
        ...
        ; if (GetKeyState LMB = stop scrolling  *************************
